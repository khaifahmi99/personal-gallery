          ...
          <div className='grid grid-cols-12'>
            <div className='col-span-12 lg:col-span-7'>
              ...
              <div className='flex flex-col md:flex-row gap-4'>
                <Link href='/#travels' className="hover:bg-emerald-100 w-4/5 md:w-1/3 flex flex-row justify-between text-zinc-900 px-4 py-2 bg-white rounded border-emerald-400 border-2 items-center">
                  <div className='text-lg'>
                    Explore Travels
                  </div>
                  <div className="w-4 h-4"><FaArrowRight /></div>
                </Link>
                <Link href='/#eats' className="hover:bg-emerald-100 w-4/5 md:w-1/3 flex flex-row justify-between text-zinc-900 px-4 py-2 bg-white rounded border-emerald-400 border-2 items-center">
                  <div className='text-lg'>
                    Explore Eats
                  </div>
                  <div className="w-4 h-4"><FaArrowRight /></div>
