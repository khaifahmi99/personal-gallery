...
export const LampTitle = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-21 lg:h-[21rem] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative hidden lg:flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
      ...
      <div className="relative z-50 flex translate-0 lg:-translate-y-[15rem] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
